    ...
    },
    {
      ...
      render: (row: ComplianceSnapshot) => (
        <button
          ...
          className="text-gray-400 hover:text-arifa-navy disabled:opacity-30"
  ...
  return (
    <div className="flex h-full flex-col p-6">
      ...
      <div className="grid min-h-0 flex-1 grid-cols-1 gap-6 lg:grid-cols-3">
        {/* Snapshots List */}
        <div className="overflow-auto rounded-lg border border-gray-200 bg-white lg:col-span-2">
          <DataTable
            columns={snapshotColumns}
            data={snapshots as (ComplianceSnapshot & Record<string, unknown>)[]}
